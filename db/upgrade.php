...
/**
 * This file keeps track of upgrades to the pbl module
 *
...
/**
 * Execute pbl upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_pbl_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field intro to be added to pbl.
        $table = new xmldb_table('pbl');
        ...
        // Define field introformat to be added to pbl.
        $table = new xmldb_table('pbl');
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timemodified to be added to pbl.
        $table = new xmldb_table('pbl');
        ...
        // Define index course (not unique) to be added to pbl.
        $table = new xmldb_table('pbl');
